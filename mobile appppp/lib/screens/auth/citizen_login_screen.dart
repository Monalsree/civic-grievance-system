    ...
    try {
      ...
      if (response['user'] != null && response['token'] != null) {
        ...
        if (user.role != 'citizen') {
          setState(() {
            _errorMessage =
                'This account is not a citizen account. Please use admin login.';
          });
          return;
        }

        await _authService.saveUser(user, response['token']);
        if (mounted) {
            ...
            child: Padding(
              ...
              child: Column(
                children: [
                  ...
                  const Text(
                    'Report and track your grievances',
                    style: TextStyle(
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      GestureDetector(
                        onTap: () => context.push('/register-citizen'),
                        child: const Text(
                          'Register',
                          style: TextStyle(
                            color: Color(0xFF667eea),
